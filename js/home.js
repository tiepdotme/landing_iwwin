...
function loadHtml() {
    ...
    div.id = 'limit-tip';
    if (isiOS) {
             div.innerHTML = '<p><img src="./images/live_ios.png?v=3" alt="Vui lòng mở trong trình duyệt của bạn" style="max-width: 100%; height: auto;"/></p>';

        } else {
            div.innerHTML = '<p><img src="./images/live_Android.png" alt="Vui lòng mở trong trình duyệt của bạn" style="max-width: 100%; height: auto;"/></p>';
        }
    // console.log(div)
