window.ShareInstall = function(win, doc, xhr) {
                ...
                success: function(e) {
                    ...
                    myAjax({
                        ...
                        success: function(e) {						
                            ...
                            "{}" == JSON.stringify(o) ? h.fallbackUrl = h.schemaUrl = "https://www.shareinstall.com.cn/no-param.html": (h.fallbackUrl = s.fallback_Url? s.fallback_Url: "https://www.shareinstall.com.cn/error.html", h.schemaUrl = s.fallback_Url? s.fallback_Url:"https://www.shareinstall.com.cn/error.html"), h.fallbackMethod = "frm", h.schemaMethod = "loc", s.fallbackDownloadHandler(), console.log("%c如果看到此条Log，证明集成没有完成", "color:red;"), console.log("%c请先排查以下事项，如仍未成功，请联系技术人员协助：", "color:red;"), console.log("%c1、请确保自定义参数不为空", "background:#222;color:#bada55;"), console.log("%c2、H5和app应用中的appkey与创建自动生成的appkey一致", "background:#222;color:#bada55;"), console.log("%c3、集成SDK的包是否已在应用集成的第二步完成包上传", "background:#222;color:#bada55;"), console.log("%c4、请保证当前测试使用的手机(模拟器)系统完成了第3步", "background:#222;color:#bada55;")),
    ...
    MyShareInstall.domainPath = "我是初始化数据...",
